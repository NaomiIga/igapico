...
def export_csv(request):
	...
	for i in userdata:
		writer.writerow([
			...
			"%s" % i.treasure3('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure4('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure5('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure6('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure7('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure8('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure9('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.treasure10('%%Y/%%m/%%d/ %%H:%%M:%%S'),
			"%s" % i.shopname,
		])
