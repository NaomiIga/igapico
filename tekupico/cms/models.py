...
class User(models.Model):
	...
	starttime = models.DateTimeField('starttime', default = 0)
	finishtime = models.DateTimeField('finishtime', default = 0)
...
class UsedHint(models.Model):
	username = models.CharField('username', max_length = 255, default = 'NAME')
	treasure1 = models.DateTimeField('hint1-1', default=0)
	treasure2 = models.DateTimeField('hint2-1', default=0)
	treasure3 = models.DateTimeField('hint3-1', default=0)
