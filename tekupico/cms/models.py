...
class User(models.Model):
	...
	treasure1 = models.DateTimeField(blank=True, null=True, default=timezone.now)
	treasure2 = models.DateTimeField(blank=True, null=True, default=timezone.now)
	treasure3 = models.DateTimeField(blank=True, null=True, default=timezone.now)
