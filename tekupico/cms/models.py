...
class User(models.Model):
	...
	#treasure1 = models.DateTimeField(default=datetime.datetime.now())
	#treasure2 = models.DateTimeField(default=datetime.datetime.now())
	#treasure3 = models.DateTimeField(default=datetime.datetime.now())
	treasure1 = models.DateTimeField(_('time'), auto_now_add=True)
	treasure2 = models.DateTimeField(_('time'), auto_now_add=True)
	treasure3 = models.DateTimeField(_('time'), auto_now_add=True)
