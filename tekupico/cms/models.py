...
class User(models.Model):
	...
	treasure4 = models.DateTimeField('4time', null=True, blank=True)
	treasure5 = models.DateTimeField('5time', null=True, blank=True)
	treasure6 = models.DateTimeField('6time', null=True, blank=True)
	treasure7 = models.DateTimeField('7time', null=True, blank=True)
	treasure8 = models.DateTimeField('8time', null=True, blank=True)
	treasure9 = models.DateTimeField('9time', null=True, blank=True)
	treasure10 = models.DateTimeField('10time', null=True, blank=True)
...
class UsedHint(models.Model):
	...
	treasure4_1 = models.DateTimeField('hint4-1', null=True, blank=True)
	treasure4_2 = models.DateTimeField('hint4-2', null=True, blank=True)
	treasure4_3 = models.DateTimeField('hint4-3', null=True, blank=True)
	treasure5_1 = models.DateTimeField('hint5-1', null=True, blank=True)
	treasure5_2 = models.DateTimeField('hint5-2', null=True, blank=True)
	treasure5_3 = models.DateTimeField('hint5-3', null=True, blank=True)
	treasure6_1 = models.DateTimeField('hint6-1', null=True, blank=True)
	treasure6_2 = models.DateTimeField('hint6-2', null=True, blank=True)
	treasure6_3 = models.DateTimeField('hint6-3', null=True, blank=True)
	treasure7_1 = models.DateTimeField('hint7-1', null=True, blank=True)
	treasure7_2 = models.DateTimeField('hint7-2', null=True, blank=True)
	treasure7_3 = models.DateTimeField('hint7-3', null=True, blank=True)
	treasure8_1 = models.DateTimeField('hint8-1', null=True, blank=True)
	treasure8_2 = models.DateTimeField('hint8-2', null=True, blank=True)
	treasure8_3 = models.DateTimeField('hint8-3', null=True, blank=True)
	treasure9_1 = models.DateTimeField('hint9-1', null=True, blank=True)
	treasure9_2 = models.DateTimeField('hint9-2', null=True, blank=True)
	treasure9_3 = models.DateTimeField('hint9-3', null=True, blank=True)
	treasure10_1 = models.DateTimeField('hint10-1', null=True, blank=True)
	treasure10_2 = models.DateTimeField('hint10-2', null=True, blank=True)
	treasure10_3 = models.DateTimeField('hint10-3', null=True, blank=True)
