...
class UserAdmin(admin.ModelAdmin):
	list_display = ('user_id', 'username', 'starttime', 'finishtime', 'treasure1', 'treasure2', 'treasure3', 'treasure4', 'treasure5', 'treasure6', 'treasure7', 'treasure8', 'treasure9', 'treasure10',)
